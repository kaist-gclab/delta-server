...
namespace Delta.AppServer.Migrations
{
    ...
    [Migration("20241119143037_AddBucketCreatedByJobRun")]
    partial class AddBucketCreatedByJobRun
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delta.AppServer.Buckets.Bucket", b =>
                {
                    ...
                    b.Property<long?>("CreatedByJobRunId")
                        .HasColumnType("bigint")
                        .HasColumnName("created_by_job_run_id");
            ...
            modelBuilder.Entity("Delta.AppServer.Buckets.Bucket", b =>
                {
                    ...
                    b.HasOne("Delta.AppServer.Jobs.JobRun", "CreatedByJobRun")
                        .WithMany()
                        .HasForeignKey("CreatedByJobRunId")
                        .OnDelete(DeleteBehavior.Restrict);
